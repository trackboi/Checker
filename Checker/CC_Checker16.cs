...
namespace Checker
{
    [Activity(Label = "CC_Checker16")]
    public class CC_Checker16 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker16);
        ...
        {
            score += 4;
            Intent intent = new Intent(this, typeof(CC_Checker17));
