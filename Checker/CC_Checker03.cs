...
namespace Checker
{
    [Activity(Label = "CC_Checker03")]
    public class CC_Checker03 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker03);
        ...
        {
            score += 2;
            Intent intent = new Intent(this, typeof(CC_Checker04));
