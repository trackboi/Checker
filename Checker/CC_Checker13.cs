...
namespace Checker
{
    [Activity(Label = "CC_Checker13")]
    public class CC_Checker13 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker13);
        ...
        {
            score += 1;
            Intent intent = new Intent(this, typeof(CC_Checker14));
