...
namespace Checker
{
    [Activity(Label = "CC_Checker05")]
    public class CC_Checker05 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker05);
        ...
        {
            score += 1;
            Intent intent = new Intent(this, typeof(CC_Checker06));
