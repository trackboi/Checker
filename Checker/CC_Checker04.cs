...
namespace Checker
{
    [Activity(Label = "CC_Checker04")]
    public class CC_Checker04 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker04);
        ...
        {
            score += 2;
            Intent intent = new Intent(this, typeof(CC_Checker05));
