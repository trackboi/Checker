...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Checker.CC_Checker04, Checker", CC_Checker04.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CC_Checker04.class)
			mono.android.TypeManager.Activate ("Checker.CC_Checker04, Checker", "", this, new java.lang.Object[] {  });
	}
