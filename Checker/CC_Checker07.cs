...
namespace Checker
{
    [Activity(Label = "CC_Checker07")]
    public class CC_Checker07 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker07);
        ...
        {
            score -= 5;
            Intent intent = new Intent(this, typeof(CC_Checker08));
