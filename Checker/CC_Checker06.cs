...
namespace Checker
{
    [Activity(Label = "CC_Checker06")]
    public class CC_Checker06 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker06);
        ...
        {
            score += 2;
            Intent intent = new Intent(this, typeof(CC_Checker07));
