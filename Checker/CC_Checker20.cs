...
namespace Checker
{
    [Activity(Label = "CC_Checker20")]
    public class CC_Checker20 : Activity
    {
        private int score;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.CC_Checker20);
        ...
        {
            score += 3;
            Intent intent = new Intent(this, typeof(CC_Checker21));
